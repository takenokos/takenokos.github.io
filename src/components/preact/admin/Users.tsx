  ...
  return (
    <>
      ...
      <button
        ...
        class="cursor-pointer mb-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition"
      >
        Create New User
      </button>
      {loading ? (
        ...
        <table class="w-full border-collapse border border-slate-300 dark:border-slate-700">
          <thead>
            <tr class="bg-slate-100 dark:bg-slate-700">
              <th class="p-2 border border-slate-300 dark:border-slate-700">
                Name
              </th>
              <th class="p-2 border border-slate-300 dark:border-slate-700">
                Email
          ...
          <tbody>
            {users.map((user) => (
              <tr
                id={`user-${user.id}`}
                class="user-list-item border-t hover:bg-slate-500/10"
              >
                ...
                <td class="p-2">
                  <button
                    ...
                    class="mr-2 px-2 py-1 bg-emerald-500 hover:opacity-80 text-white rounded cursor-pointer"
                  >
                    Edit
                  </button>
                  <button
                    onClick={() => handleDelete(user.id!)}
                    class="px-2 py-1 bg-red-500 hover:opacity-80 text-white rounded cursor-pointer"
                  >
                    Delete
                  </button>
                </td>
